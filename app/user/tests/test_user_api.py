...
class PublicUserAPITest(TestCase):
    ...
    def test_create_token_invalid_credentials(self):
        """ Tests that a token is not created if invalid credentials are given """
    ...
    def test_create_token_missing_field(self):
        """ Tests that email and password is required """
...
class PrivateUserAPITest(TestCase):
    ...
    def setUp(self):
        self.user = create_user(email="test@gmail.com", password="testpass", name="Test Name")
        self.client = APIClient()
